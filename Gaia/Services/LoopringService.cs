...
namespace Gaia
{
    public class LoopringService : ILoopringService, IDisposable
    {
        ...
        public async Task<OffchainFee> GetOffChainFee(string apiKey, int accountId, int requestType, string tokenAddress)
        {
            ...
            {
                ConsoleMessage.WriteMessage($"Error getting off chain fee: {httpException.Message}");
                return null;
            }
            catch (JsonReaderException sre)
            {
                ConsoleMessage.WriteMessage($"Error getting off chain fee: {sre.Message}");
                return null;
            }
            catch (Exception ex)
            {
                ConsoleMessage.WriteMessage($"Error getting off chain fee: {ex.Message}");
                return null;
            }
        }
        ...
        public async Task<StorageId> GetNextStorageId(string apiKey, int accountId, int sellTokenId)
        {
            ...
            {
                ConsoleMessage.WriteMessage($"Error getting storage id: {httpException.Message}");
                return null;
            }
            catch (JsonReaderException sre)
            {
                ConsoleMessage.WriteMessage($"Error getting storage id: {sre.Message}");
                return null;
            }
            catch (Exception ex)
            {
                ConsoleMessage.WriteMessage($"Error getting storage id: {ex.Message}");
                return null;
            }
        }
        ...
        public async Task<OffchainFee> GetOffChainFeeNftTransfer(string apiKey, int accountId, int requestType, string amount)
        {
            ...
            {
                ConsoleMessage.WriteMessage($"Error getting off chain fee nft transfer: {httpException.Message}");
                return null;
            }
            catch (JsonReaderException sre)
            {
                ConsoleMessage.WriteMessage($"Error getting off chain fee nft transfer: {sre.Message}");
                return null;
            }
            catch (Exception ex)
            {
                ConsoleMessage.WriteMessage($"Error getting off chain fee nft transfer: {ex.Message}");
                return null;
            }
        }
        ...
        public async Task<string> SubmitNftTransfer(string apiKey, string exchange, int fromAccountId, string fromAddress, int toAccountId, string toAddress, int nftTokenId, string nftAmount, int maxFeeTokenId, string maxFeeAmount, int storageId, long validUntil, string eddsaSignature, string ecdsaSignature, string nftData)
        {
            ...
            {
                ConsoleMessage.WriteMessage($"Error submitting nft transfer: {httpException.Message}");
                return null;
            }
            catch (JsonReaderException sre)
            {
                ConsoleMessage.WriteMessage($"Error submitting nft transfer: {sre.Message}");
                return null;
            }
            catch (Exception ex)
            {
                ConsoleMessage.WriteMessage($"Error submitting nft transfer: {ex.Message}");
                return null;
            }
        }
        ...
        public async Task<EnsResult> GetHexAddress(string apiKey, string ens)
        {
            ...
            {
                ConsoleMessage.WriteMessage($"Error getting hex address: {httpException.Message}");
                return null;
            }
            catch (JsonReaderException sre)
            {
                ConsoleMessage.WriteMessage($"Error getting hex address: {sre.Message}");
                return null;
            }
            catch (Exception ex)
            {
                ConsoleMessage.WriteMessage($"Error getting hex address: {ex.Message}");
                return null;
            }
        }
        ...
        public async Task<NftBalance> GetNftBalance(string apiKey, int accountId, string nftData)
        {
            ...
            {
                ConsoleMessage.WriteMessage($"Error getting nft balance: {httpException.Message}");
                return null;
            }
            catch (JsonReaderException sre)
            {
                ConsoleMessage.WriteMessage($"Error getting nft balance: {sre.Message}");
                return null;
            }
            catch (Exception ex)
            {
                ConsoleMessage.WriteMessage($"Error getting nft balance: {ex.Message}");
                return null;
            }
        }
        ...
        public async Task<EnsResult> GetENS(string apiKey, string hexAddress)
        {
            ...
            {
                ConsoleMessage.WriteMessage($"Error getting ens: {httpException.Message}");
                return null;
            }
            catch (JsonReaderException sre)
            {
                ConsoleMessage.WriteMessage($"Error getting ens: {sre.Message}");
                return null;
            }
            catch (Exception ex)
            {
                ConsoleMessage.WriteMessage($"Error getting ens: {ex.Message}");
                return null;
            }
        }
    }
